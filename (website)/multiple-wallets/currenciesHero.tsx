...
function CurrenciesHero() {
  return (
    <div className="max-content">
      <div className="container">
        <div className="bg-[url('/assets/svg/currenciesHeroBg.svg')] bg-cover bg-no-repeat flex justify-center  py-[64px] px-[20px] max-xlsm:py-[30px] rounded-[50px] w-full">
          <div className="max-w-[728px] flex flex-col items-center">
            <p className="font-secondary  text-center font-[400] text-[60px] leading-[86px] max-md:text-[30px] max-md:leading-[48px] text-[#2A0079]">
              <span className="text-[#5645F5]">Multiple</span> {""}
              currencies = <span className="text-[#5645F5]">multiple</span>{" "}
              wallets!{" "}
            </p>
