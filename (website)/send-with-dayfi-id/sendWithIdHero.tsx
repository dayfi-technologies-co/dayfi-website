...
function SendWIthIdHero() {
  return (
    <div className="max-content">
      <div className="container">
        <div className="bg-[url('/assets/svg/sendWithIdHeroBg.svg')] bg-cover bg-no-repeat flex justify-center  py-[64px] px-[20px] max-xlsm:py-[30px] rounded-[50px] w-full">
          <div className="max-w-[812px] flex flex-col items-center">
            <p className="font-secondary  text-center font-[400] text-[60px] leading-[86px] max-md:text-[30px] max-md:leading-[48px] text-[#2A0079]">
              <span className="text-[#5645F5]">Send and receive for FREE</span>{" "}
              with your Dayfi ID!{" "}
            </p>
