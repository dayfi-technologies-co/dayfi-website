        ...
        <div className="max-content">
          <div className="container">
            <div className="flex flex-col items-center">
              ...
              <p className="mt-[10px] w-[685px] text-center max-sixm:w-full text-[#302D53] font-primary font-[400] text-[16px] leading-[24px]">
                We revolutionise how people transact and manage their money by
                offering stand-out features, and we aim to make financial
                transactions around the world accessible, secure, and convenient
                for all.
              </p>
